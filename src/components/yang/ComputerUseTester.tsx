...
function DemoBtn({ label, desc, onClick, disabled }: { label: string; desc: string; onClick: () => void; disabled?: boolean }) {
  return (
    <button
      onClick={onClick}
      disabled={disabled}
      className="text-left bg-neutral-900 hover:bg-neutral-800 border border-neutral-800 hover:border-emerald-700/40 disabled:opacity-40 disabled:cursor-not-allowed rounded-md px-3 py-2 transition-colors"
    >
