                ...
                <div className="settings-card" style={{
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                    <div>
                      ...
                      <p className="stat-num-glow" style={{ fontFamily: "'DM Mono', monospace", fontSize: '28px', fontWeight: 400, color: 'var(--text)', letterSpacing: '-0.03em', lineHeight: 1 }}>RC 5.0</p>
                      <p style={{ fontFamily: "'DM Mono', monospace", fontSize: '10px', color: 'var(--text-muted)', letterSpacing: '0.05em', marginTop: '6px' }}>Release Candidate 5.0</p>
                    </div>
